...
class MyTheme{
  ...
  static Color accent_color = Color.fromRGBO(130,212,246, 1);
  static Color soft_accent_color = Color.fromRGBO(247,189,168, 1);
  static Color splash_screen_color = Color.fromRGBO(130,212,246, 1); // if not sure , use the same color as accent color
